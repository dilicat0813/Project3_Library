...
folder_path = r"C:\RPA\Library\Data\result"
...
#기본 DB불러오기
total = pd.read_csv("C:/RPA/Library/subscribe_extract/data/total.csv", index_col=0) #경로/이름 설정
subscribe = pd.read_csv("C:/RPA/Library/data/subscribe.csv") #경로/이름 설정
